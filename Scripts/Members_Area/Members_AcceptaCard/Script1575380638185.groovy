...
//---------------------------------------------------------------------------------------------------------------
// Prove the function Under Payments Area     |                 |                  |                             |
// Members AcceptaCard Functionality          |    03/12/2019   |     Dave Horne   |                             |
...
GlobalVariable.PAGE = "acceptacard" // Expected, But NOT, as the following 2 lines explain
...
for (GlobalVariable.row = 1; GlobalVariable.row <= findTestData('Members_Test_Data').getRowNumbers(); (GlobalVariable.row)++) {
	...
	//-----------------------------------------
	WebUI.callTestCase(findTestCase('Reusable_Test_Sequences/Members_Area/Area_Menu/Non_Dashboard_Navigation/Members_AcceptaCard'), [:], FailureHandling.CONTINUE_ON_FAILURE)
	
	//-----------------------------------------
	// Confirm Data on Returned Page          |
	//-----------------------------------------
	WebUI.callTestCase(findTestCase('Reusable_Test_Sequences/Members_Area/Validation/Members_AcceptaCard'), [:], FailureHandling.CONTINUE_ON_FAILURE)
