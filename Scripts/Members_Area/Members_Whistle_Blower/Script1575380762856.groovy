...
// Members Whistle Blower Functionality       |    04/12/2019   |     Dave Horne   |                             |
...
GlobalVariable.PAGE = "whistle-blower" // Expected, But NOT, as the following 2 lines explain
...
for (GlobalVariable.row = 1; GlobalVariable.row <= findTestData('Members_Test_Data').getRowNumbers(); (GlobalVariable.row)++) {
	...
	//-----------------------------------------
	WebUI.callTestCase(findTestCase('Reusable_Test_Sequences/Members_Area/Area_Menu/Non_Dashboard_Navigation/Members_Whistle_Blower'), [:], FailureHandling.CONTINUE_ON_FAILURE)
