...
//---------------------------------------------------------------------------------------------------------------
	...
	'---------------------------------------'
	WebUI.scrollToElement(findTestObject('Object Repository/CAT_Footer/Page_Checkatrade Find a tradesperson you can trust/div_Find Out More'), 3)
	WebUI.click(findTestObject('Object Repository/CAT_Footer/Page_Checkatrade Find a tradesperson you can trust/div_Find Out More'))
	
	'---------------------------------------'
	' Verify Returned Page is as Expected   |'
	'---------------------------------------'
	WebUI.callTestCase(findTestCase('Reusable_Test_Sequences/CAT_Footer/Trades/Find_Out_More_Verification'), [:], FailureHandling.CONTINUE_ON_FAILURE)
