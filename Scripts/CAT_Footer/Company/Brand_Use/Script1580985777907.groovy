...
//                                                                                                               |
//	WHEN -  We Navigate Company-Brand Use from the Page Footer Hyperlink                                         |
//                                                                                                               |
//  THEN -  The Resulting Outcome is that the <Checkatrade.com Brand Guidelines Page> Page is Returned           |
//                                                                                                               |
//---------------------------------------------------------------------------------------------------------------
	...
	'---------------------------------------'
	' Navigate to Company->Brand Use        |' //  Only Used ONCE - Hence, Not In Reuse Folder
	'---------------------------------------'
	WebUI.scrollToElement(findTestObject('Object Repository/CAT_Footer/Page_Checkatrade Find a tradesperson you can trust/div_Brand Use'), 3)
	WebUI.click(findTestObject('Object Repository/CAT_Footer/Page_Checkatrade Find a tradesperson you can trust/div_Brand Use'))
	
	'---------------------------------------'
	' Verify Returned Page is as Expected   |'
	'---------------------------------------'
	WebUI.callTestCase(findTestCase('Reusable_Test_Sequences/CAT_Footer/Company/Brand_Use_Verification'), [:], FailureHandling.CONTINUE_ON_FAILURE)
