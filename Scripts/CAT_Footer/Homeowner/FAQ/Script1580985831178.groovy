...
//                                                                                                               |
//	WHEN -  We Navigate Homeowner - FAQ from the Page Footer Hyperlink                                           |
//                                                                                                               |
//  THEN -  The Resulting Outcome is that the <Frequently Asked Questions> Page is Returned                      |
//                                                                                                               |
//---------------------------------------------------------------------------------------------------------------
	...
	'--------------------------------------------'
	' Navigate to Homeowner->FAQ                 |' //  Only Used ONCE - Hence, Not In Reuse Folder
	'--------------------------------------------'
	WebUI.scrollToElement(findTestObject('Object Repository/CAT_Footer/Page_Checkatrade Find a tradesperson you can trust/div_FAQ'), 3)
	WebUI.click(findTestObject('Object Repository/CAT_Footer/Page_Checkatrade Find a tradesperson you can trust/div_FAQ'))
	
	'---------------------------------------'
	' Verify Returned Page is as Expected   |'
	'---------------------------------------'
	WebUI.callTestCase(findTestCase('Reusable_Test_Sequences/CAT_Footer/Homeowner/FAQ_Verification'), [:], FailureHandling.CONTINUE_ON_FAILURE)
