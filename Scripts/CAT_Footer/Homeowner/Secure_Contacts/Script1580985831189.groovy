...
//                                                                                                               |
//	WHEN -  We Navigate Homeowner - Secure Contacts from the Page Footer Hyperlink                               |
//                                                                                                               |
//  THEN -  The Resulting Outcome is that the <What are secure contact details> Page is Returned                 |
//                                                                                                               |
//---------------------------------------------------------------------------------------------------------------
	...
	'--------------------------------------------'
	' Navigate to Homeowner->Secure Contacts     |' //  Only Used ONCE - Hence, Not In Reuse Folder
	'--------------------------------------------'
	WebUI.scrollToElement(findTestObject('Object Repository/CAT_Footer/Page_Checkatrade Find a tradesperson you can trust/div_Secure Contacts'), 3)
	WebUI.click(findTestObject('Object Repository/CAT_Footer/Page_Checkatrade Find a tradesperson you can trust/div_Secure Contacts'))
	
	'---------------------------------------'
	' Verify Returned Page is as Expected   |'
	'---------------------------------------'
	WebUI.callTestCase(findTestCase('Reusable_Test_Sequences/CAT_Footer/Homeowner/Secure_Contacts_Verification'), [:], FailureHandling.CONTINUE_ON_FAILURE)
