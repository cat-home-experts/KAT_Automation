...
//-----------------------------------------
	...
	'-----------------------------------------------------------------'
	WebUI.callTestCase(findTestCase('Reusable_Test_Sequences/Web_Office/Navigation/Sub_Menu_Navigation/Settings/Web_Office/Marketing_Sources'), [:], FailureHandling.STOP_ON_FAILURE)
	
	'--------------------------------------'
	' Verify Returned Page Detail          |'
	'--------------------------------------'
	WebUI.callTestCase(findTestCase('Reusable_Test_Sequences/Web_Office/Verification/Settings/Web_Office/Marketing_Sources'), [:], FailureHandling.OPTIONAL)
