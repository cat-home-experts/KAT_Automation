...
//---------------------------------------------------------------------------------------------------------------
//  Navigate <Whistle Blower> from <Your      |   03/12/2019    |        DH        |  Need to Include WB data    |
//  Account>->Membership->Whistle Blower from |                 |                  |  Member Name and Data Plus  |
//  Members Header Menus (Not Available from  |                 |                  |  Comments and Radio Button  |
//  Members Dashboard                         |                 |                  |  Selection Checks           |
//---------------------------------------------------------------------------------------------------------------
//                                            |                 |                  |                             |
//---------------------------------------------------------------------------------------------------------------
//                                            |                 |                  |                             |
...
////////////////////////////////////////////
WebUI.waitForElementClickable(findTestObject('Object Repository/Page_Members Area/Header_Menus/Page_Members Area/a_Whistle Blower'), 1)
