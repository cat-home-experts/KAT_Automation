...
'----------------------------------------------'
WebUI.verifyTextPresent("New Alerts", false)
'----------------------------------------------'
' NEW Page Content, Added Below'
'----------------------------------------------'
WebUI.verifyTextPresent("From time to time we become aware of people trying to scam you. ", false)
'----------------------------------------------'
WebUI.verifyTextPresent("Here we will keep you informed of any threats we are made aware of", false)
'----------------------------------------------'
...
'----------------------------------------------'
WebUI.verifyTextPresent("Phishing Email", false)
'----------------------------------------------'//'----------------------------------------------'
