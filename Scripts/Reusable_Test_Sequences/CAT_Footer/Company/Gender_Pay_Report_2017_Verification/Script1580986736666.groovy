...
'-------------------------------------------------------------------------------------'
'full URL for Preview == https://www.preview.checkatrade.com/Downloads/GenderPay.pdf  |'
'-------------------------------------------------------------------------------------'
if(currentURL.contains('checkatrade.com/Downloads/GenderPay.pdf')){
	KeywordUtil.markPassed("Our 2017 Gender Pay Gap Report PDF Presented, as Expected")
} else {
	KeywordUtil.markFailed("Our 2017 Gender Pay Gap Report PDF WAS NOT Presented, as Expected")
}
