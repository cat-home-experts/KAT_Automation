...
// Returns Home Advice Centre Page VALIDATION |                 |                  |                             |
//---------------------------------------------------------------------------------------------------------------
//                                            |                 |                  |                             |
//---------------------------------------------------------------------------------------------------------------
//                                            |                 |                  |                             |
...
'----------------------------------------------'
WebUI.verifyTextPresent("Homeowner Advice Centre", false)
'----------------------------------------------'
'Sub Header'
...
'----------------------------------------------'
WebUI.verifyTextPresent("Our homeowner advice centre offers tools, expert guidance and inspiration", false)
'----------------------------------------------'
WebUI.verifyTextPresent("for home projects with insider tips from our checked vetted tradespeople", false)
'----------------------------------------------'
...
'----------------------------------------------'
WebUI.verifyTextPresent("Cost Guides", false)
'----------------------------------------------'
WebUI.verifyTextPresent("Inspiration", false)
'----------------------------------------------'
WebUI.verifyTextPresent("How-To", false)
'----------------------------------------------'
