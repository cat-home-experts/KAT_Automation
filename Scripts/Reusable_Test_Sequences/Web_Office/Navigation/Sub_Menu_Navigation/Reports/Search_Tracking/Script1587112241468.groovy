...
WebUI.waitForElementClickable(findTestObject('Object Repository/WebOffice_Home_page/a_Search Tracking'), 5)
WebUI.click(findTestObject('Object Repository/WebOffice_Home_page/a_Search Tracking'))
