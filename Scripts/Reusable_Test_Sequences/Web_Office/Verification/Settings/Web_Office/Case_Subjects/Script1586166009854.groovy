...
WebUI.delay(1)
	...
	// Header
	'----------------------------------------------'
	WebUI.verifyTextPresent("Case Subjects", false)
	'----------------------------------------------'

	// Sub Section - Table Header
	'----------------------------------------------'
	WebUI.verifyTextPresent("Case Subject", false)
	'----------------------------------------------'
	...
	'----------------------------------------------'
	WebUI.verifyTextPresent("Advertising", false)
	'----------------------------------------------'
	...
	'----------------------------------------------'
	WebUI.verifyTextPresent("Manual Accreditations tank for Vetting", false)
	'----------------------------------------------'
	WebUI.verifyTextPresent("bad debt provision", false)
	'----------------------------------------------'
