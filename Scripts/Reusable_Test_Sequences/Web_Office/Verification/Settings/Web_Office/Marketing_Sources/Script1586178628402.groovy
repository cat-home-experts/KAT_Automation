...
WebUI.delay(1)
	...
	// Header
	'----------------------------------------------'
	WebUI.verifyTextPresent("Marketing Sources", false)
	'----------------------------------------------'
	...
	'----------------------------------------------'
	WebUI.verifyTextPresent("Directory Enquiry", false)
	'----------------------------------------------'
	WebUI.verifyTextPresent("TV Campaign", false)
	'----------------------------------------------'
	WebUI.verifyTextPresent("SMS", false)
	'----------------------------------------------'
	WebUI.verifyTextPresent("Radio Campaign", false)
	'----------------------------------------------'
	WebUI.verifyTextPresent("Lapsed", false)
	'----------------------------------------------'
