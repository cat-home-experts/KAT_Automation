...
WebUI.delay(1)
	...
	// Header
	'----------------------------------------------'
	WebUI.verifyTextPresent("Marketing Materials Requests By Type", false)
	'----------------------------------------------'
	...
	// Table Header
	'----------------------------------------------'
	WebUI.verifyTextPresent("Marketing Material Title", false)
	'----------------------------------------------'
	WebUI.verifyTextPresent("Total Requested", false)
	'----------------------------------------------'

	// Table Dtat Sample
	'----------------------------------------------'
	WebUI.verifyTextPresent("CAT Welcome Letter - Pre RVM", false)
	'----------------------------------------------'
