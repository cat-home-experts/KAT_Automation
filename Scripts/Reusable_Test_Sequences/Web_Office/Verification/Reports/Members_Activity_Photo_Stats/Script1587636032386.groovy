...
WebUI.delay(1)
	...
	// Header
	'----------------------------------------------'
	WebUI.verifyTextPresent("Members Area Photo Statistics Report", false)
	'----------------------------------------------'
	...
	'----------------------------------------------'
	WebUI.verifyTextPresent("Total no. uploaded photos", false)
	'----------------------------------------------'
	...
	'----------------------------------------------'
	WebUI.verifyTextPresent("Gallery", false)
	'----------------------------------------------'
	...
	'----------------------------------------------'
	WebUI.verifyTextPresent("Gilbert Driveways", false)
	'----------------------------------------------'
	WebUI.verifyTextPresent("Logo", false)
	'----------------------------------------------'
	WebUI.verifyTextPresent("A C E Building Services (WM) Ltd", false)
	'----------------------------------------------'
'--------------------------------'
'           END                  |'
'--------------------------------'
