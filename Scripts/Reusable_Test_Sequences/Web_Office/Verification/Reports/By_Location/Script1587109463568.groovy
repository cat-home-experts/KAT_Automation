...
WebUI.delay(1)
	...
	// Header
	'----------------------------------------------'
	WebUI.verifyTextPresent("Searches by Location", false)
	'----------------------------------------------'
	
	// Sub Headers, Tabs, Headers-

	'----------------------------------------------'
	WebUI.verifyTextPresent("Select counties", false)
	'----------------------------------------------'
...
//
	// Footer
	'----------------------------------------------'
	WebUI.verifyTextPresent("Tip: Use Shift or Control when clicking on the lists to select multiple options", false)
	'----------------------------------------------'
