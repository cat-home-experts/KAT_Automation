...
WebUI.delay(1)
	...
	'----------------------------------------------'
	 WebUI.verifyTextPresent("Popular Categories", false)
	'----------------------------------------------'
	// headers
	...
	'----------------------------------------------'
	WebUI.verifyTextPresent("No. Searches", false)
	'----------------------------------------------'
	...
	'----------------------------------------------'
	WebUI.verifyTextPresent("Builder", false)
	'----------------------------------------------'
	WebUI.verifyTextPresent("Electrician", false)
	'----------------------------------------------'
	WebUI.verifyTextPresent("Roofer", false)
	'----------------------------------------------'
	WebUI.verifyTextPresent("Painter/Decorator", false)
	'----------------------------------------------'
	WebUI.verifyTextPresent("Carpenter", false)
	'----------------------------------------------'
	WebUI.verifyTextPresent("Plasterer", false)
	'----------------------------------------------'
	WebUI.verifyTextPresent("Roofing Repairs", false)
	'----------------------------------------------'
	WebUI.verifyTextPresent("Landscaper", false)
	'----------------------------------------------'
//
