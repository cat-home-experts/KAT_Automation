...
WebUI.click(findTestObject('CAT_Footer/Page_Checkatrade Site map/img_Follow Us On_Footer__Social_Twitt'))

WebUI.click(findTestObject('CAT_Footer/Page_Checkatrade Site map/img_Follow Us On_Footer__Social_Face'))
